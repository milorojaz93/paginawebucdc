<template>
  <b-container id="container-fullsize" fluid>
    <b-row id="container-fullsize">
      <b-col id="container-fullsize" style="padding: 40px" cols="12" lg="12" xl="12" md="12" sm="12" xs="12">
        <h3><strong>POLÍTICA DE PRIVACIDAD</strong></h3>
        <p>
          El presente Política de Privacidad establece los términos en que UCDC - Urban City Dance
          Company usa y protege la información que es proporcionada por sus usuarios al momento de
          utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de
          sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual
          usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con
          los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con
          el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente
        ...
        <p>
          UCDC - Urban City Dance Company está altamente comprometido para cumplir con el compromiso
        ...
        <p>
          ...
          personal que es proporcionada a nuestro <a href="" target="_blank"></a>.&nbsp; Cada vez
          que se le solicite rellenar un formulario, como el de alta de usuario, puede marcar o
        ...
        <p>
          UCDC - Urban City Dance Company Se reserva el derecho de cambiar los términos de la
